...
## Project Structure
    ...
    ├── data_model_datingap_25236  # Django project configurations
...
1. Clone this repo and `cd data_model_datingap_25236`
...
2. Clone this repo and `cd data_model_datingap_25236`
